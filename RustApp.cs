...
namespace Oxide.Plugins
{
    ...
    public class RustApp : RustPlugin
    {
        ...
        private static class CourtApi
        {
            ...
            private static string BaseUrl => _Settings?.admin_panel_api_url ?? "https://court.rustapp.io";
        ...
        private static class QueueApi
        {
            ...
            private static string BaseUrl => _Settings?.admin_panel_queue_url ?? "https://queue.rustapp.io";
        ...
        {
            private static string BaseUrl => _Settings?.admin_panel_ban_url ?? "https://ban.rustapp.io";
        ...
        private class Configuration
        {
            ...
            [JsonProperty("[Admin panel] API URL")]
            public string admin_panel_api_url = "http://127.0.0.1:3000/api/rust";

            [JsonProperty("[Admin panel] Queue URL")]
            public string admin_panel_queue_url = "http://127.0.0.1:3000/api/rust/queue";

            [JsonProperty("[Admin panel] Ban API URL")]
            public string admin_panel_ban_url = "http://127.0.0.1:3000/api/rust/ban";
            ...
            public static Configuration Generate()
            {
                return new Configuration
                {
                    ...
                    admin_panel_api_url = "http://127.0.0.1:3000/api/rust",
                    admin_panel_queue_url = "http://127.0.0.1:3000/api/rust/queue",
                    admin_panel_ban_url = "http://127.0.0.1:3000/api/rust/ban",
                };
            }
        }
